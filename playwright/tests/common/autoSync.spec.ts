...
test.run()(
  "I can see the auto-sync succeed when making a change",
...
test.run()(
  "I can see the auto-sync succeed after a failed attempt",
  async ({ pageTypesBuilderPage, reusablePageType, procedures }) => {
    procedures.mock(
      "prismicRepository.fetchEnvironments",
      () => ({ environments }),
...
test.run()(
  "I can see the auto-sync fail because of an hard limit",
  async ({ pageTypesBuilderPage, reusablePageType, procedures }) => {
    procedures.mock(
      "prismicRepository.fetchEnvironments",
      () => ({ environments }),
