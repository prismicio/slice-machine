...
test("I can see the in-app guide open by default", async ({
  sliceMachinePage,
}) => {
...
test("I can close the in-app guide", async ({ sliceMachinePage }) => {
  await sliceMachinePage.gotoDefaultPage();
...
test("I can see the in-app guide on different pages", async ({
  sliceMachinePage,
  slicesListPage,
