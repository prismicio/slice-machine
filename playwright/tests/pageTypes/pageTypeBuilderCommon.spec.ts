...
test.run()(
  ...
  async ({ pageTypesBuilderPage, reusablePageType, procedures }) => {
...
test.run()(
  "I can delete the custom type",
  async ({ pageTypesBuilderPage, reusablePageType, pageTypesTablePage }) => {
    await pageTypesBuilderPage.goto(reusablePageType.name);
...
test.run()(
  "I can see the page code snippet and copy the content",
  async ({ pageTypesBuilderPage, reusablePageType }) => {
    await pageTypesBuilderPage.goto(reusablePageType.name);
