...
test("I can see a warning if the selected release note has a breaking changes", async ({
  changelogPage,
  procedures,
}) => {
  const releaseNotes =
...
test("I cannot see a warning if the selected release does not contain a breaking change", async ({
  changelogPage,
  procedures,
}) => {
...
test("I can see the yarn latest update command", async ({
  changelogPage,
  procedures,
}) => {
...
test("I can see the npm latest update command", async ({
  changelogPage,
  procedures,
}) => {
