...
Every user can now easily set up Slice Machine in his project using a single command line : `npx @slicemachine/init`
...
To avoid doing back and forth between your terminal and the UI. Now when you try to push your data model to Prismic and you are not connected or your connection expired, you will be asked to login with a direct link to do so.
