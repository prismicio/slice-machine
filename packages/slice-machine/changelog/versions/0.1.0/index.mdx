...
You can now define which Slice should be included in the Custom Type SliceZone.
...
We rethinked the SliceMachine UI/UX to make it clearer and simpler to use.
...
- We added the Link to Media field for Slices and Custom Types
