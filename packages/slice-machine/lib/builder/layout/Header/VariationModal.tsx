...
const VariationModal: React.FunctionComponent<{
    isOpen: boolean,
    onClose: () => any,
    onSubmit: (id: string, name: string, copiedVariation: Variation<AsArray>) => void
          ...
          <Form id={'variation-add'}>
            <Box>
              <Card
                ...
                FooterContent={
                  <Flex sx={{justifyContent: 'flex-end'}}>
                    <Button onClick={handleClose} mr={2} variant="secondary">Cancel</Button>
              ...
              >
                ...
                <Box sx={{ pb: 4 }}>
                <Label htmlFor="origin" sx={{mb: 1}}>Duplicate from</Label>
                  <Select
                    name="origin"
