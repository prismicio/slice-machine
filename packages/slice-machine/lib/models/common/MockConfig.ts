...
export const SliceMockConfig = {
  getSliceMockConfig(globalMockConfig: GlobalMockConfig, libName:string, sliceName:string) {
    return globalMockConfig?.[libName]?.[sliceName] || {}
  },
  getVariationMockConfig(sliceMockConfig: SliceMockConfig, variationId:string) {
    return sliceMockConfig[variationId] || {}
  },
  getFieldMockConfig(sliceMockConfig: SliceMockConfig, variationId: string, widgetArea: WidgetsArea, fieldId: string) {
    return this.getVariationMockConfig(sliceMockConfig, variationId)[widgetArea]?.[fieldId] || {}
  },
  deleteFieldMockConfig(sliceMockConfig: SliceMockConfig, variationId: string, widgetArea: WidgetsArea, fieldId: string) {
    return {
      ...sliceMockConfig,
      [variationId]: {
  ...
  updateFieldMockConfig(sliceMockConfig: SliceMockConfig, variationId: string, widgetArea: WidgetsArea, previousKey: string, fieldId: string, value: any) {
    return {
      ...sliceMockConfig,
      [variationId]: {
        ...this.getVariationMockConfig(sliceMockConfig, variationId),
...
export const CustomTypeMockConfig = {
  ...
  updateFieldMockConfig(ctMockConfig: CustomTypeMockConfig, previousFieldId: string, fieldId: string, value: any) {
    return {
      ...ctMockConfig,
  ...
  updateGroupFieldMockConfig(ctMockConfig: CustomTypeMockConfig, groupId: string, previousFieldId:string, fieldId: string, value: any) {
    return {
      ...ctMockConfig,
      [groupId]: {
  ...
  deleteGroupFieldMockConfig(ctMockConfig: CustomTypeMockConfig, groupId: string, fieldId: string) {
    return {
      ...ctMockConfig,
      [groupId]: {
        ...this.getFieldMockConfig(ctMockConfig, groupId),
