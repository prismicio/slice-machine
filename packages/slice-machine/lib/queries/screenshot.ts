...
export function getExternalPathToScreenshot({ cwd, from, sliceName }: { cwd: string, from: string, sliceName: string }): { exists: boolean, path: string, isCustom: boolean } | undefined {
