...
import { CustomTypeStateProvider } from "./CustomTypeProvider";
...
> = ({ customType: customTypeFromStore }) => {
  ...
  return (
    <AppLayout>
      <CustomTypeStateProvider
        defaultCustomType={CustomTypes.fromSM(customTypeFromStore)}
      >
        {({ autoSaveStatus, customType }) => {
