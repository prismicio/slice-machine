...
const Zone = ({
  ...
  const onSelectFieldType = (widgetTypeName) => {
    ...
    // the widgetsArray is not typed and is also filtered into `widgetsArrayWithCondUid` but seems
    // safe to use it to index the `Widgets` object, as it will have the props we need
