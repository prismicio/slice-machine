...
describe('utils/findWidgetByConfigOrType', () => {
  ...
  test('We can find the ContentRelationship widget with the right config', () => {
    ...
    const widgetFound = findWidgetByConfigOrType(Widgets, contentRelationshipConfig, FieldType.Link)
