...
# Clone your fork
git clone git@github.com:<your-username>/slicemachine-adapter-next.git
...
## `@slicemachine/adapter-next` in Prismic's Open-Source Ecosystem
...
[repo-issue]: https://github.com/prismicio/slicemachine-adapter-next/issues/new/choose
