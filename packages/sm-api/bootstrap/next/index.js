...
const nextConfig = fs.readFileSync(path.join(__dirname, 'files/_document.mustache'), 'utf-8');
const prismic = fs.readFileSync(path.join(__dirname, 'files/next.config.mustache'), 'utf-8');
const smResolver = fs.readFileSync(path.join(__dirname, 'files/prismic.mustache'), 'utf-8');
